        ...
        save: function(submitValue) {
            ...
            */
            ...
            if (send) { //send to server
                ...
                if(typeof this.options.processResult === 'function') {
                    params = this.options.processResult.call(this.options.scope, params);  
                }
...
(function ($) {
    ...
    var Constructor = function (options) {
        ...
        if(!options.select2.tags && options.source) {
            ...
            if (typeof source === 'string') {
                this.sourceData = this.convertSource(JSON.parse(source));
    ...
    $.extend(Constructor.prototype, {
       ...
       str2value: function(str, separator) {
        ...
        // Converts source from select format: {value: 1, text: "1"} to select2 format: {id: 1, text: "1"}
