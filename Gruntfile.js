function getFiles() {
    ...
    var task, folder, dest, concat_files = {}, min_files = {}, cssmin_files = [];
    for (var k in config) {
        ...
        //css
        task = k + '_css';
        dest = folder + 'css/' + prefix + '-editable';
        concat_files[task] = {
    ...
    return { concat_files: concat_files, min_files: min_files, cssmin_files: cssmin_files };
...
module.exports = function (grunt) {
        ...
        copy: {
            dist: {
                files: [
                    ...
                    //licences
                    { expand: true, flatten: true, dest: '<%= dist %>/', src: ['LICENSE.txt', 'README.md', 'CHANGES.txt'] }
                ]
            },
            // inputs_ext: {
            //     expand: true,
    ...
    // Default task.
    grunt.registerTask('default', ['clean', 'jshint', 'concat', 'uglify', 'cssmin', 'copy']);
